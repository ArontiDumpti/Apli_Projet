...
<div class="container pb-6 pt-6">
	...
	<form action="./php/producto_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<div class="column">
		    	<div class="control">
					<label>Pasillo</label>
				  	<input class="input" type="text" name="producto_ub_p" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/]{1,25}" maxlength="25" required value="<?php echo $datos['producto_ub_p']; ?>" >
				</div>
		  	</div>
			  <div class="column">
		    	<div class="control">
					<label>Estante</label>
				  	<input class="input" type="text" name="producto_ub_e" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/]{1,25}" maxlength="25" required value="<?php echo $datos['producto_ub_e']; ?>" >
				</div>
		  	</div>
			  <div class="column">
		    	<div class="control">
					<label>Nivel</label>
				  	<input class="input" type="text" name="producto_ub_n" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/]{1,25}" maxlength="25" required value="<?php echo $datos['producto_ub_n']; ?>" >
				</div>
		  	</div>
