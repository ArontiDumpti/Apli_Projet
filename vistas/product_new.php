	...
	<form action="./php/producto_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data" >
		...
		<div class="columns">
			...
			<div class="column">
		    	<div class="control">
					<label>Pasillo</label>
				  	<input class="input" type="text" name="producto_ub_p" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/]{1,25}" maxlength="25" required >
				</div>
		  	</div>
			  <div class="column">
		    	<div class="control">
					<label>Estante</label>
				  	<input class="input" type="text" name="producto_ub_e" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/]{1,25}" maxlength="25" required >
				</div>
				<div class="column">
		    	<div class="control">
					<label>Nivel</label>
				  	<input class="input" type="text" name="producto_ub_n" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/]{1,25}" maxlength="25" required >
				</div>
		  	</div>
		  	</div>
		</div>
